...
-- AddForeignKey
ALTER TABLE "_AmpStoryDataToAmpStoryPageData" ADD FOREIGN KEY ("A") REFERENCES "AmpStoryData"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmpStoryDataToAmpStoryPageData" ADD FOREIGN KEY ("B") REFERENCES "AmpStoryPageData"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmpStoryGridLayerDataToAmpStoryPageData" ADD FOREIGN KEY ("A") REFERENCES "AmpStoryGridLayerData"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmpStoryGridLayerDataToAmpStoryPageData" ADD FOREIGN KEY ("B") REFERENCES "AmpStoryPageData"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmpMediaDataToAmpStoryGridLayerData" ADD FOREIGN KEY ("A") REFERENCES "AmpMediaData"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmpMediaDataToAmpStoryGridLayerData" ADD FOREIGN KEY ("B") REFERENCES "AmpStoryGridLayerData"("id") ON DELETE CASCADE ON UPDATE CASCADE;
